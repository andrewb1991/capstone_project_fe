...
const ManageProductsList = () => {
  ...
  const navigateEditProductPage = async (e) => {
  return navigate("/editproduct")
  }
    const editSubmit = async (_id, e) =>{
      e.preventDefault()
    confirmAlert({
      title: `Modifica`,
              ...
              <>
                <MDBTableBody>
                  <tr>
                    ...
                    <td>
                      <MDBBtn onClick={(e)=>editSubmit(product._id, e)} color="primary" rounded size="sm">
